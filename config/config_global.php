...
// ----------------------------  CONFIG DB  ----------------------------- //
$_config['db']['1']['dbhost'] = '115.28.10.252:3306';
$_config['db']['1']['dbuser'] = 'root';
$_config['db']['1']['dbpw'] = 'zhang@#13590';
$_config['db']['1']['dbcharset'] = 'gbk';
$_config['db']['1']['pconnect'] = '0';
$_config['db']['1']['dbname'] = 'luntan30';
$_config['db']['1']['tablepre'] = 'pre18_';
$_config['db']['slave'] = '';
...
// --------------------------  CONFIG COOKIE  --------------------------- //
$_config['cookie']['cookiepre'] = 'Z4xp_';
$_config['cookie']['cookiedomain'] = '';
$_config['cookie']['cookiepath'] = '/';

// -------------------------  CONFIG SECURITY  -------------------------- //
$_config['security']['authkey'] = 'fdccc0FN4Scl5Bmh';
