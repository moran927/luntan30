...
0
|| checktplrefresh('data/diy/./template/travel_linzi//forum/viewthread.htm', './template/travel_linzi/forum/viewthread_node.htm', 1387533738, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', 'data/diy/./template/travel_linzi/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/travel_linzi//forum/viewthread.htm', './template/travel_linzi/forum/viewthread_fastpost.htm', 1387533738, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', 'data/diy/./template/travel_linzi/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/travel_linzi//forum/viewthread.htm', './template/travel_linzi/forum/viewthread_node_body.htm', 1387533738, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', 'data/diy/./template/travel_linzi/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/travel_linzi//forum/viewthread.htm', './template/default/common/seditor.htm', 1387533738, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', 'data/diy/./template/travel_linzi/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/travel_linzi//forum/viewthread.htm', './template/default/common/seccheck.htm', 1387533738, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', 'data/diy/./template/travel_linzi/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/travel_linzi//forum/viewthread.htm', './template/default/common/upload.htm', 1387533738, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', 'data/diy/./template/travel_linzi/', 'forum/viewthread')
;
block_get('64,63,65,66,67');?><?php include template('common/header'); ?><style type="text/css">

    .layout {width: 680px !important; overflow:hidden; clear:both}
    .bbs_sldline2{ margin: 20px 0}
    .pls{ border-right: none}
.rs_main{ min-width:600px}
.plc{ padding:0}
...
<div class="bbs_titbox">
        <h1 class="bbs_titbox_title ">
            <em id="thread_subject"><?php echo $_G['forum_thread']['subject'];?></em>
            <span class="xg1">
                ...
                &nbsp;<img src="<?php echo IMGDIR;?>/hot_<?php echo $_G['forum_thread']['heatlevel'];?>.gif" alt="" title="<?php echo $_G['forum_thread']['heatlevel'];?> 热度" />
                <?php } ?>
                <?php if($_G['forum_thread']['closed'] == 1) { ?>
                &nbsp;<img src="<?php echo IMGDIR;?>/locked.gif" alt="关闭" title="关闭" class="vm" />
                <?php } ?>
                <a href="forum.php?mod=viewthread&amp;tid=<?php echo $_G['tid'];?><?php echo $fromuid;?>" class="copy" onclick="return copyThreadUrl(this)" title="您的朋友访问此链接后，您将获得相应的积分奖励">[复制链接]</a>
            </span>
        </h1>
       
        <div class="bbs_titi_infos">
            <div class="pi"<?php if($close_leftinfo) { ?> style="height:48px"<?php } ?>>
                 <?php if(!IS_ROBOT) { ?>
                ...
                <div class="pti">
                    ...
                    <div class="authi">
                        ...
                        <a href="home.php?mod=space&amp;uid=<?php echo $post['authorid'];?>" target="_blank" class="xi2" style="float:left;padding-right:10px;"><img src="<?php echo $_G['setting']['ucenterurl'];?>/avatar.php?uid=<?php echo $post['authorid'];?>&size=small" /></a>
                        <?php } ?>
                        <?php if($thread['author'] && $post['author'] == $thread['author']) { ?>
                        <?php } else { ?>
                        ...
                        <?php if($_G['forum_thread']['attachment'] == 2 && (!$_G['setting']['guestviewthumb']['flag'] || $_G['setting']['guestviewthumb']['flag'] && $_G['uid'])) { ?>
                        ...
                        <?php } ?>
                        <?php if($post['first']) { ?>
                        <span class="pipe">|</span><a href="javascript:;" onclick="readmode($('thread_subject').innerHTML, $('postmessage_<?php echo $post['pid'];?>').innerHTML);">阅读模式</a>
                        <?php } ?>
                        ...
                        <span class="txt" style=" padding: 0 5px">查看:<strong><?php echo $_G['forum_thread']['views'];?></strong> 回复:<strong><?php echo $_G['forum_thread']['replies'];?></strong></span>
                    </div>
                </div>
            </div>
        </div>
...
<div class="bbs_sidebar">
    <div class="bbs_toolbox">
        ...
        <div class="bbs_tools bbs_tools_scroll">
            ...
            <div class="bdlikebutton z" style="width:85px; height:28px; margin-top:5px"></div>
            ...
            <a href="home.php?mod=spacecp&amp;ac=favorite&amp;type=thread&amp;id=<?php echo $_G['tid'];?>" id="k_favorite" class="collect" onclick="showWindow(this.id, this.href, 'get', 0);" onmouseover="this.title = $('favoritenumber').innerHTML + ' 人收藏'" title="收藏本帖">收藏<span id="favoritenumber"<?php if(!$_g['forum_thread']['favtimes']) { ?> style="display:none"<?php } ?>><?php echo $_G['forum_thread']['favtimes'];?></span></a>
             <!-- Baidu Button BEGIN -->
            <a class="shareCount share"></a>
            <script type="text/javascript" id="bdshare_js" data="type=tools&amp;uid=682365" ></script>
    ...
    <!--[diy=diy2]--><div id="diy2" class="area"><div id="framejMCT7Q" class="frame move-span cl frame-1"><div id="framejMCT7Q_left" class="column frame-1-c"><div id="framejMCT7Q_left_temp" class="move-span temp"></div><?php block_display('64');?><?php block_display('63');?><?php block_display('65');?><?php block_display('66');?><?php block_display('67');?></div></div></div><!--[/diy]-->
...
<div class="userinfo">
                <div class="authi"><a href="javascript:;" class=""><?php echo $post['author'];?></a>  </div>
                            
    </div>
   
<div class="authorinfo">        
                <em id="authorposton7561541"><?php if($close_leftinfo) { ?>
                        <a href="home.php?mod=space&amp;uid=<?php echo $post['authorid'];?>" target="_blank" class="xi2" style="float:left;padding-right:10px;"><img src="<?php echo $_G['setting']['ucenterurl'];?>/avatar.php?uid=<?php echo $post['authorid'];?>&size=small" /></a>
                        <?php } ?>
                        <?php if($thread['author'] && $post['author'] == $thread['author']) { ?>
                        <?php } else { ?>
...
<div class="pattl">
<?php if($post['imagelist'] && $_G['setting']['imagelistthumb'] && $post['imagelistcount'] >= $_G['setting']['imagelistthumb']) { if(!isset($imagelistkey)) { $imagelistkey = rawurlencode(md5($_G[tid].'|100|100'))?><script type="text/javascript" reload="1">var imagelistkey = '<?php echo $imagelistkey;?>';</script>
...
<?php if($_G['setting']['ratelogon']) { ?>
                	<p class="rate_title">
                    	...
                    	<a href="forum.php?mod=misc&amp;action=viewratings&amp;tid=<?php echo $_G['tid'];?>&amp;pid=<?php echo $post['pid'];?>" onclick="showWindow('viewratings', this.href)" title="查看全部评分">已有 <span class="xi1"><?php echo count($postlist[$post['pid']]['totalrate']);; ?></span> 人评分</a><i class="dotted_splt"></i>
...
<td class="xi1" width="50"> + <?php echo $ratelog['score'][$id];?></td>
<?php } else { ?>
<td class="xg1" width="50"><?php echo $ratelog['score'][$id];?></td>
<?php } } ?>
...
<?php } if(!IS_ROBOT && $post['first'] && !$_G['forum_thread']['archiveid']) { if($post['invisible'] == 0) { } } if($post['relateitem']) { ?>
<div class="mtw mbw">
