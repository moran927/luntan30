...
0
|| checktplrefresh('./template/travel_linzi/forum/forumdisplay_fastpost.htm', './template/default/common/seditor.htm', 1387533813, '2', './data/template/2_2_forum_forumdisplay_fastpost.tpl.php', './template/travel_linzi', 'forum/forumdisplay_fastpost')
|| checktplrefresh('./template/travel_linzi/forum/forumdisplay_fastpost.htm', './template/default/common/seccheck.htm', 1387533813, '2', './data/template/2_2_forum_forumdisplay_fastpost.tpl.php', './template/travel_linzi', 'forum/forumdisplay_fastpost')
;?>
